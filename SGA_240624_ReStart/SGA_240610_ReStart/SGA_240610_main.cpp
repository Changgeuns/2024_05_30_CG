...
int main()
{
	...
	{
		TestWorld* t_world = new TestWorld();
		...
		cout << "잘못된 접근이라고 알리는것에대해 알린다고 알림" << endl;
	...
	/*Creature* knight = new Knight("haha", 100, 15);
	Creature* archer = new Archer("haha", 100, 15);
