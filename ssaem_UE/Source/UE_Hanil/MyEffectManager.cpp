...
AMyEffectManager::AMyEffectManager()
{
	...
	CreateParticle("meleeAttack", "/Script/Engine.ParticleSystem'/Game/ParagonNarbash/FX/Particles/Skins/BashOLantern/Abilities/Primary/P_BashOLantern_Melee_Impact.P_BashOLantern_Melee_Impact'");
}
...
{
	if (_table.Contains(name) == false) return;
